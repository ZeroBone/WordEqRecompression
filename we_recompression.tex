		...
		\]\begin{center}
			\fbox{
				\parbox{0.75\textwidth}{
					No more occurrences of $ ab \in \Gamma_l \Gamma_r $ in $ U $ or $ V $.
				}
			}
		\end{center}
	}
...
\begin{frame}
	\frametitle{Analysis of the algorithm for word equations}
	
	Preliminary observation:
	
	\begin{itemize}
		\item The algorithm never changes the number of variable occurrences in the equation;
		\item Let that number be $ n_v $;
	\end{itemize}
\end{frame}

\begin{frame}
	\frametitle{Space consumption}
	
	\begin{itemize}
		\item How many letters get popped into the equation as a result of block compression
	\end{itemize}
\end{frame}
